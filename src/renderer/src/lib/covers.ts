...
// own behavior.
export async function fetchCatalogueFacets(client: SupabaseClient = supabase): Promise<CatalogueFacets> {
...
// client parameter as fetchCataloguePage, for the same reason.
